...
CREATE DATABASE IF NOT EXISTS `qlsach` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `qlsach`;
...
CREATE TABLE IF NOT EXISTS `ctpm` (
  ...
  KEY `MaSach` (`MaSach`),
  KEY `User` (`User`),
  CONSTRAINT `ctpm_ibfk_1` FOREIGN KEY (`MaPM`) REFERENCES `phieumuon` (`MaPM`),
  CONSTRAINT `ctpm_ibfk_2` FOREIGN KEY (`MaSach`) REFERENCES `sach` (`MaSach`),
  CONSTRAINT `ctpm_ibfk_3` FOREIGN KEY (`User`) REFERENCES `taikhoan` (`User`)
...
INSERT INTO `ctpm` (`MaPM`, `MaSach`, `NgayTra`, `TinhTrangSach`, `TinhTrangTra`, `User`, `GhiChu`) VALUES
	...
	(15, 96, '2024-12-16', 100, 100, 'admin', 'Sach moi'),
	...
	(48, 1, '2024-12-06', 100, 100, 'admin', 'Sách mới'),
	(49, 5, NULL, 100, NULL, NULL, NULL),
	(50, 1, '2024-12-16', 100, 100, 'admin', 'Moi'),
	(51, 8, NULL, 100, NULL, NULL, NULL),
	(51, 10, NULL, 100, NULL, NULL, NULL),
	(51, 12, NULL, 100, NULL, NULL, NULL),
	(51, 15, NULL, 100, NULL, NULL, NULL),
	(51, 17, NULL, 100, NULL, NULL, NULL),
	(52, 6, NULL, 100, NULL, NULL, NULL),
	(52, 13, NULL, 100, NULL, NULL, NULL),
	(52, 21, NULL, 100, NULL, NULL, NULL),
	(52, 22, NULL, 100, NULL, NULL, NULL),
	(52, 23, NULL, 100, NULL, NULL, NULL),
	(53, 1, '2024-12-19', 100, 100, 'admin', 'Sach moi'),
	(53, 14, NULL, 100, NULL, NULL, NULL),
	(53, 18, NULL, 100, NULL, NULL, NULL),
	(53, 22, NULL, 100, NULL, NULL, NULL),
	(53, 24, NULL, 100, NULL, NULL, NULL);
...
INSERT INTO `docgia` (`MaDG`, `TenDG`, `SDT`, `DiaChi`, `GioiTinh`, `MatSach`, `CCCD`) VALUES
	(1, 'Đỗ Nhật Quang', '0342565857', 'Quận Thủ Đức', 'Nam', 0, '027207884729'),
	(2, 'Trần Quốc Phong', '0981249458', 'Quận Gò Vấp', 'Nam', 1, '027207884561'),
	(3, 'Lê Thị Thanh Tiến', '0983216950', 'Quận 2', 'Nữ', 1, NULL),
	(4, 'Nguyễn Thái Hòa', '0356721980', 'Quận 9', 'Nam', 3, NULL),
	(5, 'Phan Thanh Phú Thọ', '0914469424', 'Quận Gò Vấp', 'Nam', 2, NULL),
	(6, 'Hồ Phương Ly', '0522004039', 'Quận Thủ Đức', 'Nữ', 0, NULL),
	(7, 'Phan Ngọc Phương Nhi', '0682144611', 'Quận 5', 'Nữ', 0, NULL),
	(8, 'Lê Thị Mỹ Diệu', '0347526510', 'Quận 1', 'Nữ', 0, NULL),
	(9, 'Nguyễn Thị Mỹ Dung', '0714521035', 'Quận 10', 'Nữ', 0, NULL),
	(10, 'Lữ Thị Ngọc Hiền', '0996215423', 'Quận 2', 'Nữ', 0, NULL),
	(11, 'Nguyễn Phương Lan', '0888621540', 'Quận 1', 'Nữ', 0, NULL),
	(12, 'Đỗ Thị Như Quỳnh', '0732561485', 'Huyện Cần Giờ', 'Nữ', 0, NULL),
	(13, 'Nguyễn Thị Hà Thuyên', '0962532564', 'Quận 8', 'Nữ', 0, NULL),
	(14, 'Lê Ngọc Tiến', '0632547125', 'Quận 1', 'Nam', 0, NULL),
	(15, 'Nguyễn Lê Mỹ Hòa', '0856212356', 'Quận 10', 'Nữ', 0, NULL),
	(16, 'Phan Phúc Khánh', '0571222356', 'Quận 5', 'Nam', 0, NULL),
	(17, 'Trần Thanh Lâm', '0975263510', 'Quận 2', 'Nam', 0, NULL),
	(18, 'Đỗ Nguyễn Vân Anh', '0974142514', 'Quận 1', 'Nữ', 0, NULL),
	(19, 'Nguyễn Quốc Huy', '0814252012', 'Quận 9', 'Nam', 0, NULL),
	(20, 'Nguyễn Thanh Hiển', '0345112456', 'Quận 9', 'Nam', 0, NULL),
	(21, 'Trần Thanh Hiếu', '0845124785', 'Quận 10', 'Nam', 0, NULL),
	(22, 'Đỗ Mẫn Nhi', '0641114507', 'Quận 2', 'Nữ', 0, NULL),
	(23, 'Ngô Minh Thư', '0774150121', 'Quận 7', 'Nữ', 0, NULL),
	(24, 'Ngô Khánh Hà', '0841112045', 'Quận 9', 'Nữ', 0, NULL),
	(25, 'Trần Khôi Nguyên', '0888142012', 'Quận 5', 'Nam', 0, NULL),
	(26, 'Tạ Hồng Đức', '0957154200', 'Quận Gò Vấp', 'Nam', 0, NULL),
	(27, 'Ngô Thúy Hiền', '0314211212', 'Quận 12', 'Nữ', 0, NULL),
	(28, 'Đỗ Ngọc Anh', '0314211212', 'Quận 3', 'Nữ', 0, NULL),
	(29, 'Phan Thanh Kha', '0984145201', 'Quận 10', 'Nam', 0, NULL),
	(30, 'Trần Xuân Lộc', '0654121450', 'Quận Tân Phú', 'Nam', 0, NULL),
	(31, 'Hà Doãn Minh', '0714520124', 'Quận Tân Phú', 'Nam', 0, NULL),
	(32, 'Đào Phạm Toàn', '0614017894', 'Quận Tân Phú', 'Nam', 0, NULL),
	(33, 'Hồ Thị Trinh', '0341568547', 'Quận Tân Bình', 'Nữ', 0, NULL),
	(34, 'Phan Hồ Anh Thư', '0341510412', 'Quận Tân Phú', 'Nữ', 0, NULL),
	(35, 'Đỗ Ngọc Thiên', '0874114120', 'Quận 3', 'Nam', 0, NULL),
	(36, 'Hồ Đăng Khoa', '0651425011', 'Quận 3', 'Nam', 0, NULL),
	(37, 'Lê Chí Trung', '0874145145', 'Quận 1', 'Nam', 0, NULL),
	(38, 'Bùi Thúy Kiều', '0645147887', 'Quận 12', 'Nữ', 0, NULL),
	(39, 'Phan Ngọc Thư', '0741478947', 'Quận 10', 'Nữ', 0, NULL),
	(40, 'Phan Thành Nhân', '0654178941', 'Quận 7', 'Nam', 0, NULL),
	(41, 'Lê Khôi Thành', '0347845120', 'Quận Gò Vấp', 'Nam', 0, NULL),
	(42, 'Mã Tiến Huy', '0999874520', 'Quận Gò Vấp', 'Nam', 0, NULL),
	(43, 'Châu Ngọc Minh Thư', '0357125894', 'Quận Bình Thạnh', 'Nữ', 0, NULL),
	(44, 'Nguyễn Trần Hà Đức', '0871421501', 'Quận 3', 'Nam', 0, NULL),
	(45, 'Nguyễn Hữu Nhật Tân', '0614631549', 'Quận 1', 'Nam', 0, NULL),
	(46, 'Phan Viết Đức', '0417521483', 'Quận 10', 'Nam', 0, NULL),
	(47, 'Phan Vĩnh Khoa', '0971420156', 'Quận 9', 'Nam', 0, NULL),
	(48, 'Võ Minh Khang', '0991478156', 'Quận 7', 'Nam', 0, NULL),
	(49, 'Nguyễn Thu Huyền', '0624710586', 'Quận 5', 'Nữ', 0, NULL),
	(50, 'Đào Thị Thu Hiền', '0714508041', 'Quận 3', 'Nữ', 0, NULL),
	(51, 'Trần Nhật Linh', '0314540478', 'Quận 10', 'Nam', 0, NULL),
	(52, 'Hồ Minh Huy', '0971542314', 'Quận Thủ Đức', 'Nam', 0, NULL),
	(53, 'Bùi Xuân Hồng', '0982142357', 'Quận Tân Bình', 'Nữ', 0, NULL),
	(54, 'Nguyễn Sơn Ca', '0315677152', 'Quận Tân Bình', 'Nữ', 0, NULL),
	(55, 'Nguyễn Bảo Nghĩa', '0417622478', 'Quận 5', 'Nam', 0, NULL),
	(56, 'Phan Thị Thùy Mi', '0687415245', 'Quận 8', 'Nữ', 0, NULL),
	(57, 'Ngô Nguyễn Khôi', '0971423103', 'Quận 1', 'Nam', 0, NULL),
	(58, 'Bùi Thành Hưng', '0571204612', 'Quận 9', 'Nam', 0, NULL),
	(59, 'Lê Minh Thành', '09142113010', 'Quận 2', 'Nam', 0, NULL),
	(60, 'Trương Yến Nhi', '04120703421', 'Quận 3', 'Nữ', 0, NULL),
	(61, 'Nguyễn Hữu Hiếu', '0972163012', 'Quận 5', 'Nam', 0, NULL),
	(62, 'Trần Tấn Công', '0782143015', 'Quận 2', 'Nam', 0, NULL),
	(63, 'Đoàn Thúy Ngân', '0535344210', 'Quận 8', 'Nữ', 0, NULL),
	(64, 'Võ Hoàng Tuấn', '0341258710', 'Quận Thủ Đức', 'Nam', 0, NULL),
	(65, 'Mai Thanh Hiền', '0871534453', 'Quận Thủ Đức', 'Nữ', 0, NULL),
	(66, 'Nguyễn Bảo Trân', '0789653100', 'Quận Tân Phú', 'Nữ', 0, NULL),
	(67, 'Bạch Thị Ngọc', '0345410053', 'Quận Tân Bình', 'Nữ', 0, NULL),
	(68, 'Bùi Thị Kim Thoa', '0542113033', 'Quận 9', 'Nữ', 0, NULL),
	(69, 'Nguyễn Quốc Linh', '0333333333', 'Bắc Ninh', 'Nam', 0, NULL),
	(70, 'Hoàng Văn Huy', '0385907309', 'Hà Nội', 'Nam', 0, '027294502266');
...
CREATE TABLE IF NOT EXISTS `phieumuon` (
  ...
  KEY `MaDG` (`MaDG`),
  KEY `User` (`User`),
  CONSTRAINT `phieumuon_ibfk_1` FOREIGN KEY (`MaDG`) REFERENCES `docgia` (`MaDG`),
  CONSTRAINT `phieumuon_ibfk_2` FOREIGN KEY (`User`) REFERENCES `taikhoan` (`User`)
...
INSERT INTO `phieumuon` (`MaPM`, `MaDG`, `NgayMuon`, `NgayHenTra`, `SoLuongMuon`, `User`) VALUES
	...
	(48, 70, '2024-12-05', '2025-01-01', 1, 'admin'),
	(49, 70, '2024-12-05', '2025-01-10', 1, 'admin'),
	(50, 1, '2024-12-16', '2025-01-30', 1, 'admin'),
	(51, 69, '2024-12-17', '2025-01-31', 5, 'admin'),
	(52, 67, '2024-12-17', '2025-01-31', 5, 'admin'),
	(53, 67, '2024-12-19', '2025-02-02', 5, 'admin');
...
INSERT INTO `sach` (`MaSach`, `TenSach`, `TenTG`, `NhaXB`, `TheLoai`, `SoLuong`, `GiaTien`) VALUES
	(1, 'Cơ sở dữ liệu', 'Vũ Minh Sang', 'NXB ĐHQG TP.HCM', 'Giáo trình', 8, 150000),
	(2, 'Đại số tuyến tính', 'Đặng Lệ Thúy', 'NXB ĐHQG TP.HCM', 'Giáo trình', 10, 50000),
	(3, 'Luật Im Lặng', 'Mario Puzo', 'ĐHQG Hà Nội', 'Văn học nước ngoài', 10, 75000),
	(4, 'Tuổi trẻ hoang dại', 'Nguyễn Ngọc Thạch', 'NXB Văn Học', 'Kỹ năng sống', 9, 95000),
	(5, '3 Phút Sơ Cứu', 'Ngô Đức Hùng', 'NXB Thế Giới', 'Chăm sóc sức khỏe', 10, 125000),
	(6, 'Gửi tuổi trẻ yêu thương', 'Kim Wook', 'NXB Dân Trí', 'Kỹ năng sống', 9, 109000),
	(7, 'Tâm lý học tích cực', 'Edward Hoffman', 'NXB Lao Động', 'Kỹ năng sống', 9, 129000),
	(8, 'Quy tắc 5 giây', 'Mel Robbins', 'NXB Thế Giới', 'Kỹ năng sống', 9, 135000),
	(9, 'Phương pháp tạo động lực trong công việc', 'Jon Sternfeld', 'NXB Lao Động', 'Kỹ năng sống', 10, 160000),
	(10, 'Chạm', 'Werner Bartens', 'NXB Thanh Niên', 'Kỹ năng sống', 8, 122000),
	(11, 'Chủ nghĩa tối giản', 'Fields Millburn', 'NXB Lao Động Xã Hội', 'Kỹ năng sống', 10, 139000),
	(12, 'Văn phòng không nhạt nhẽo', 'Hương Lan', 'NXB Dân Trí', 'Kỹ năng sống', 8, 80000),
	(13, 'Đời thay đổi khi ta thôi đẩy', 'Sarah Knight', 'NXB Thế Giới', 'Kỹ năng sống', 8, 92000),
	(14, 'Điều vĩ đại đời thường', 'Robin Sharma', 'NXB Trẻ', 'Kỹ năng sống', 9, 73000),
	(15, 'Đừng bao giờ đi ăn một mình', 'Keith Ferrazzi', 'NXB Trẻ', 'Kỹ năng sống', 9, 95000),
	(16, 'Siêu trí nhớ', 'Dominic O’Brien', 'NXB Lao Động', 'Kỹ năng sống', 10, 99000),
	(17, 'Mặc đẹp để thành công', 'Nishimura Yukiko', 'NXB Thế Giới', 'Kỹ năng sống', 9, 99000),
	(18, 'Trở thành siêu nhân ghi nhớ', 'Oopsy', 'NXB Thế Giới', 'Kỹ năng sống', 9, 89000),
	...
	(21, 'Đọc sách siêu tốc', 'Christian Gruning', 'NXB Lao Động', 'Kỹ năng sống', 9, 69000),
	(22, 'Bạn chính là thông điệp', 'Roger Ailes', 'NXB Thanh Hóa', 'Kỹ năng sống', 8, 79000),
	(23, 'Bí quyết học nhanh nhớ lâu', 'Jonathan Hancock', 'NXB Trẻ', 'Kỹ năng sống', 17, 48000),
	(24, 'Bài học của Thầy', 'Nhóm tác giả', 'NXB Hà Nội', 'Kỹ năng sống', 19, 35000),
	...
	(96, 'Dẫn Dắt Sự Thay Đổi', 'John P Kotter', 'NXB Thế Giới', 'Quản lý kinh doanh', 9, 129000),
...
INSERT INTO `taikhoan` (`User`, `Password`, `PhanQuyen`, `TenND`, `SDT`, `CMND`) VALUES
	...
	('dinhvy', '123123', 2, 'Nguyễn Đình Vỹ', '0312345678', '11111111111111'),
